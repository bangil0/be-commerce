<?php namespace App\Http\Controllers;
	...
	class AdminPageController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Feature Image","name"=>"feature_image","image"=>true];
			...
			$this->form[] = ['label'=>'Feature Image','name'=>'feature_image','type'=>'upload','width'=>'col-sm-10'];
