<?php namespace App\Http\Controllers;
	...
	class AdminPromoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Percent","name"=>"percent"];
			$this->col[] = ["label"=>"Link","name"=>"link"];
			$this->col[] = ["label"=>"Button Text","name"=>"button_text"];
			...
			$this->form[] = ['label'=>'Percent','name'=>'percent','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Link','name'=>'link','type'=>'text','validation'=>'required|url','width'=>'col-sm-10','placeholder'=>'Please enter a valid URL'];
			$this->form[] = ['label'=>'Button Text','name'=>'button_text','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'select','validation'=>'required','width'=>'col-sm-9','dataenum'=>'On;Off'];
